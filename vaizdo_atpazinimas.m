...
for k = 1:raidziu_sk
    switch b2(k)
        case 1
            ...
            atsakymas = [atsakymas, 'А'];
        case 2
            atsakymas = [atsakymas, 'Б'];
        case 3
            atsakymas = [atsakymas, 'В'];
        case 4
            atsakymas = [atsakymas, 'Г'];
        case 5
            atsakymas = [atsakymas, 'Л'];
        case 6
            atsakymas = [atsakymas, 'Н'];
        case 7
            atsakymas = [atsakymas, 'О'];
        case 8
            atsakymas = [atsakymas, 'Х'];
       % case 9
